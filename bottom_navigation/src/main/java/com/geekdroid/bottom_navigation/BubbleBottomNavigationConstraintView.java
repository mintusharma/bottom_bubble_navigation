...
public class BubbleBottomNavigationConstraintView extends ConstraintLayout implements View.OnClickListener, IBubbleNavigation {
    ...
    //constants
    private static final String TAG = "BBNLView";
    ...
    public BubbleBottomNavigationConstraintView(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public BubbleBottomNavigationConstraintView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, null);
    }

    public BubbleBottomNavigationConstraintView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
