...
import com.geekdroid.bottom_navigation.util.ViewUtils;

public class BubbleBottomToggleView extends RelativeLayout {

    private static final String TAG = "BNI_View";
    private static final int DEFAULT_ANIM_DURATION = 300;

    private BubbleBottomToggleItem bubbleToggleItem;
     ...
     * Constructors
     */
    public BubbleBottomToggleView(Context context) {
        super(context);
        init(context, null);
    }

    public BubbleBottomToggleView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BubbleBottomToggleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BubbleBottomToggleView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        bubbleToggleItem = new BubbleBottomToggleItem();
